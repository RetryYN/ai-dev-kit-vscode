...
generates:
  - artifact_path: docs/v2/L6-functional-design/helix-workflows-edge-case-design.md
...
- 生成物: `docs/v2/L6-functional-design/helix-workflows-edge-case-design.md`
