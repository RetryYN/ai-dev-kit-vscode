...
> **本 PLAN の対象**: L0 企画書 §8 の L1 バトン (L1-IN-01〜21) を**どう詰めて採択/保留/見送り判断し、採択分を L1 4 doc に振り分けるか**の進め方 + 採択判断の軌跡。
>
...
| Step | 作業 | 進捗 |
|---|---|---|
| 1 | L0 §8 の L1-IN-01〜21 を精読 | ☑ completed (2026-05-28) |
...
## §2 要点書 (L1-IN-01〜21 採択判断の軌跡)

> 振り分け先 FR-* は機能要求 doc §1 の対応、詳細振り分けは L1 4 doc §5 が正本 (本 PLAN は判断軌跡の集約であり、FR 内容を重複記載しない)。
...
| L1-IN-18 | 採択 | 技術要求 (詳細 §5) | 既存資産整理・マッピング (implementation_status 列必須) |
| L1-IN-19 | 採択 | 技術要求 (詳細 §5) | 既存資産の段階移行・retrofit (Strangler Fig) |
| L1-IN-20 | 採択 | 技術要求 (詳細 §5) | doc 品質レビュー継続化 (doc-reviewer role) |
| L1-IN-21 | 採択 | 技術要求 (詳細 §5) | デグレ禁止ガードレール (上流→下流追随 ratchet) |
...
- ☑ L1-IN-01〜21 全 21 件の採択判断が本 PLAN §2 に集約されている
