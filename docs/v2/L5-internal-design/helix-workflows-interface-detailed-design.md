...
## §14 横断的関心事 (cross-cutting concerns) — 正本移設済 (recovery-2026-05-30)

> 正本は [helix-workflows-cross-cutting-design.md](./helix-workflows-cross-cutting-design.md) に独立化 (recovery-2026-05-30)。ロギング / エラー伝播 / トランザクション境界 / セキュリティ横断の 4 関心事は上記文書を参照。IEEE Std 1016-2009 Patterns use viewpoint / arc42 §8 準拠。
