...
| registry_checks.py | 登録・検出 共通基盤 (RegistryLoader/Entry/Report/Finding/GatePolicy) | FR-09 | FR-INV-01 |
| functional_registry_checks.py | functional-registry 劣化検出 (check_functional_registry/check_fr_sot_alignment/load) | FR-09 | FR-INV-01 |
| functional_registry_seed.py | functional-registry md→yaml seeder | FR-09 | FR-INV-01 |
