...
## HELIX 連携
- HELIX フェーズ: L7 デプロイ / L8 受入
- HELIX CLI: `helix pr` で PR 自動生成 (ゲート結果反映) / `helix gate G7` で安定性ゲート
- リリースノート品質: technical-writing スキル併用
- ロールバック計画: shipping-and-launch スキルの runbook 節参照
