...
created: 2026-MM-DD
owner: PM
process_layer: L1             # ★必須: 工程番号 (HELIX-workflows 正本)
parent_process: HELIX-workflows/helix-process/L1-requirements.md   # ★必須: 工程定義 doc
...
詳細は [HELIX-workflows/helix-process/L1-requirements.md](../../../../HELIX-workflows/helix-process/L1-requirements.md) §この工程の PLAN を参照。
...
- HELIX-workflows: HELIX-workflows/helix-process/L1-requirements.md
