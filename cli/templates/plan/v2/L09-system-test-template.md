---
plan_id: L9-総合テストplan
title: "L9-総合テストplan: <タイトル placeholder>"
kind: test
layer: L9
...
created: 2026-MM-DD
owner: PM
process_layer: L9             # ★必須: 工程番号 (HELIX-workflows 正本)
parent_process: HELIX-workflows/helix-process/L9-system-test.md   # ★必須: 工程定義 doc
...
generates:
  - artifact_path: docs/v2/L9-<feature>/<feature>.md
...
- `L9-総合テストplan`: 総合テスト
- `L9-依存関係解消plan`: 依存関係解消

### 各 PLAN の記載項目

詳細は [HELIX-workflows/helix-process/L9-system-test.md](../../../../HELIX-workflows/helix-process/L9-system-test.md) §この工程の PLAN を参照。

## §3 成果物

- **製本対象 doc**: `docs/v2/L9-<area>/<feature>.md` (本 PLAN が完成させる正本)
- **HELIX-workflows 正本**: [HELIX-workflows/helix-process/L9-system-test.md](../../../../HELIX-workflows/helix-process/L9-system-test.md)
- **ペア凍結**: (ペア凍結なし)
...
- HELIX-workflows: HELIX-workflows/helix-process/L9-system-test.md
- 工程 doc: docs/v2/process/L09-system-testing.md
