...
created: 2026-MM-DD
owner: PM
process_layer: L12             # ★必須: 工程番号 (HELIX-workflows 正本)
parent_process: HELIX-workflows/helix-process/L12-deployment.md   # ★必須: 工程定義 doc
...
> **正本**: HELIX-workflows/helix-process/L12-deployment.md
...
詳細は [HELIX-workflows/helix-process/L12-deployment.md](../../../../HELIX-workflows/helix-process/L12-deployment.md) §この工程の PLAN を参照。

## §3 成果物

- **製本対象 doc**: `docs/v2/L12-<area>/<feature>.md` (本 PLAN が完成させる正本)
- **HELIX-workflows 正本**: [HELIX-workflows/helix-process/L12-deployment.md](../../../../HELIX-workflows/helix-process/L12-deployment.md)
...
- HELIX-workflows: HELIX-workflows/helix-process/L12-deployment.md
