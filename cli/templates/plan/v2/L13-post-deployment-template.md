...
created: 2026-MM-DD
owner: PM
process_layer: L13             # ★必須: 工程番号 (HELIX-model 正本)
parent_process: HELIX-model/L13-post-deployment-verification.md   # ★必須: 工程定義 doc
...
dependencies:
  ...
  blocks: []
related_docs:
  - HELIX-model/L13-post-deployment-verification.md
...
> **工程**: L13 ((ペア凍結なし))
> **正本**: HELIX-model/L13-post-deployment-verification.md
...
詳細は [HELIX-model/L13-post-deployment-verification.md](../../../../HELIX-model/L13-post-deployment-verification.md) §この工程の PLAN を参照。

## §3 成果物

- **製本対象 doc**: `docs/v2/L13-<area>/<feature>.md` (本 PLAN が完成させる正本)
- **HELIX-model 正本**: [HELIX-model/L13-post-deployment-verification.md](../../../../HELIX-model/L13-post-deployment-verification.md)
- **ペア凍結**: (ペア凍結なし)
...
- HELIX-model: HELIX-model/L13-post-deployment-verification.md
