...
> G3 通過条件を満たすための WBS / 依存 / feature flag / rollback / L7 Sprint 接続を固定する。
...
| WBS ID | タスク | 担当 role | 依存 | 期間 | 環境 | L7 Sprint | HELIX command / delegation | feature flag | rollback | 受入条件 |
|--------|--------|-----------|------|------|------|-----------|----------------------------|--------------|----------|----------|
