...
assert payload["summary"] == {
    ...
    "repository_add_feature_files_discovered": 35,
    "current_objective_deferred_feature_tickets": 11,
    "out_of_current_objective_add_feature_files": 24,
...
assert payload["repository_add_feature_inventory_contract"] == {
    ...
    "all_repository_add_feature_files_checked": 35,
    "current_objective_deferred_feature_tickets_checked": 11,
    "excluded_from_current_objective_deferred_count": 24,
...
assert c3de_entry["path"] == "docs/plans/add-feature/add-feature-2026-06-19-plandep-depcycle-baseline-required.md"
assert c3de_entry["observed_status"] == "draft"
assert c3de_entry["classification"] == "current_scope_authorized_c3de_plandep_depcycle_baseline_required"
...
assert c4a_entry["path"] == "docs/plans/add-feature/add-feature-2026-06-19-g8-integration-execution-gate.md"
assert c4a_entry["observed_status"] == "draft"
assert c4a_entry["classification"] == "current_scope_authorized_c4a_g8_integration_execution_gate"
...
c4b_entry = excluded_by_id["c4b_g9_system_execution_gate"]
assert c4b_entry["id"] == "c4b_g9_system_execution_gate"
assert c4b_entry["path"] == "docs/plans/add-feature/add-feature-2026-06-20-g9-system-execution-gate.md"
assert c4b_entry["observed_status"] == "draft"
assert c4b_entry["classification"] == "current_scope_authorized_c4b_g9_system_execution_gate"
assert "C-4b" in c4b_entry["reason"]
assert "G9 / L4-L9" in c4b_entry["reason"]
assert "g9_subcheck" in c4b_entry["reason"]
assert "anchored 5/18" in c4b_entry["reason"]
assert "approved_deferred" in c4b_entry["reason"]
assert "G12/G14 deferred" in c4b_entry["reason"]
c4c_entry = excluded_by_id["c4c_g12_acceptance_execution_gate"]
assert c4c_entry["id"] == "c4c_g12_acceptance_execution_gate"
assert c4c_entry["path"] == "docs/plans/add-feature/add-feature-2026-06-20-g12-acceptance-execution-gate.md"
assert c4c_entry["observed_status"] == "draft"
assert c4c_entry["classification"] == "current_scope_authorized_c4c_g12_acceptance_execution_gate"
assert "C-4c" in c4c_entry["reason"]
assert "G12 / L3-L12" in c4c_entry["reason"]
assert "g12_subcheck" in c4c_entry["reason"]
...
assert c4d_entry["path"] == "docs/plans/add-feature/add-feature-2026-06-20-g14-operational-learning-gate.md"
assert c4d_entry["observed_status"] == "draft"
assert c4d_entry["classification"] == "current_scope_authorized_c4d_g14_operational_learning_gate"
...
assert payload["ratification_summary"]["right_arm_execution_gates_deferred"] == 3
...
assert payload["current_l1_l6_evidence"]["ratification_index"]["expected"] == {
    ...
    "deferred_feature_unlock_conditions_checked": 11,
        "deferred_repository_add_feature_files_discovered": 35,
    "deferred_current_objective_deferred_feature_tickets": 11,
        "deferred_out_of_current_objective_add_feature_files": 24,
    ...
    "full_objective_feature_tickets_available": 11,
        "full_objective_repository_add_feature_files_discovered": 35,
    "full_objective_current_objective_deferred_feature_tickets": 11,
        "full_objective_out_of_current_objective_add_feature_files": 24,
...
assert glob_patterns == {
    ...
    "docs/plans/add-feature/add-feature-*.md": 35,
}
...
for gate_id, (pair, plan_id) in expected.items():
    ...
    expected_state = "gate_implemented" if gate_id in {"G9", "G12", "G14"} else "plan_materialized"
    ...
    assert gate["implemented"] is expected_implemented
    assert gate["passed"] is False
    assert gate["deferred_reason"] == expected_reason
...
assert payload["ci_surface"]["required_next"][1] == "Require strict full-flow overall_clean=true after the remaining G9/G12/G14 pass while preserving G8 closure."
...
assert snapshot["vg_overview"]["deferred_gates"] == ["G9", "G12", "G14"]
