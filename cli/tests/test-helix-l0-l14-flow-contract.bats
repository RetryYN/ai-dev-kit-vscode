...
assert any(path == "cli/lib/push_gate.py" for path in handover_state["files"]["pending"])
...
assert payload["ratification_summary"]["reference_integrity_path_like_refs_checked"] == 1383
assert payload["ratification_summary"]["reference_integrity_direct_file_refs_checked"] == 1374
