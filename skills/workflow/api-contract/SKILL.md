...
## 8. DS-120 第6章 政府準拠 reference

Informative 参考。強制ルール化はしない。

DS-120 第6章の調達仕様書標準テンプレートを、API 契約レビュー時の観点整理に使える。
...
- API 仕様レビューで、上記 6 項目の抜け漏れ確認に使う
- D-API / D-CONTRACT の記述を、調達仕様書の観点へ写像する補助表として使う
- 政府準拠の記述は参照情報に留め、HELIX の必須ゲートにはしない
